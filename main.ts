...
let mySprite = sprites.create(assets.image`robot 1`, SpriteKind.Player)
mp.setPlayerSprite(mp.playerSelector(mp.PlayerNumber.One), sprites.create(assets.image`robot 1`, SpriteKind.Player))
mp.setPlayerSprite(mp.playerSelector(mp.PlayerNumber.Two), sprites.create(assets.image`robot 1`, SpriteKind.Player))
mp.setPlayerSprite(mp.playerSelector(mp.PlayerNumber.Three), sprites.create(assets.image`robot 1`, SpriteKind.Player))
mp.setPlayerSprite(mp.playerSelector(mp.PlayerNumber.Four), sprites.create(assets.image`robot 1`, SpriteKind.Player))
...
forever(function () {
    music.play(music.stringPlayable("E E F E D F E D ", 120), music.PlaybackMode.UntilDone)
    music.play(music.stringPlayable("A B C5 B A C5 B A ", 120), music.PlaybackMode.UntilDone)
    music.play(music.stringPlayable("E D E F G E D F ", 120), music.PlaybackMode.UntilDone)
})
forever(function () {
